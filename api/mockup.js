module.exports =  {
    ...
    'yarn install': 'yarn install\n' +
        ...
        '✨  Done in 0.75s.',
    'yarn dev': 'Compiled with warnings.\n' +
        '\n' +
        './src/features/pane/Pane.js\n' +
        '  Line 1:16:  \'useState\' is defined but never used  no-unused-vars\n' +
        '\n' +
        './src/features/console/Console.js\n' +
        '  Line 2:8:    \'ReactDOM\' is defined but never used       no-unused-vars\n' +
        '  Line 5:23:   \'useDispatch\' is defined but never used    no-unused-vars\n' +
        '  Line 27:15:  \'pane\' is assigned a value but never used  no-unused-vars\n' +
        '\n' +
        './src/index.js\n' +
        '  Line 5:10:  \'configureStore\' is defined but never used  no-unused-vars\n' +
        '  Line 7:9:   \'paneAdded\' is defined but never used       no-unused-vars',
    'node -v': 'v12.16.1'
};